                ...
                <div className="absolute -mt-20 w-full flex justify-center">
                  <ScrollAnimation>
                    <div className="h-32 w-32">
                      <img
                        src="https://pixner.net/zooshi/main/assets/images/team4.png"
                        alt
              ...
              <div className="rounded overflow-hidden shadow-md bg-white">
                <div className="absolute -mt-20 w-full flex justify-center">
                  <ScrollAnimation>
                    <div className="h-32 w-32">
                      <img
                        src="https://pixner.net/zooshi/main/assets/images/team5.png"
                        alt
                        className="rounded-full object-cover h-full w-full shadow-md"
                      />
                    </div>
              ...
              <div className="rounded overflow-hidden shadow-md bg-white">
                <div className="absolute -mt-20 w-full flex justify-center">
                  <ScrollAnimation>
                    <div className="h-32 w-32">
                      <img
                        src="https://pixner.net/zooshi/main/assets/images/team6.png"
                        alt
                        className="rounded-full object-cover h-full w-full shadow-md"
                      />
                    </div>
