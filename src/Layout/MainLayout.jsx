        ...
        <NavLink
          className={({ isActive, isPending }) =>
            isPending
              ? "pending"
              : isActive
              ? "border-b-2 rounded-none border-[#85B72C]"
              : "containers"
          }
          to="/"
        >
    ...
    <div onClick={handleClick} >
      <div className="drawer relative">
        ...
        <div className="drawer-content flex flex-col">
          ...
          <div className="sticky top-0 mt-2 z-50 bg-white">
            <div className="w-full navbar max-w-7xl mx-auto justify-between">
              ...
              <div className="px-2 py-1">
                <img
                  className="w-[170px]"
                  src="https://androthemes.com/themes/angular/cookiteer/assets/img/logo.png"
                  alt=""
                />
              </div>
                  ...
                  {user ? (
                    <div className="relative">
                      <img
                        ...
                        className="rounded-full cursor-pointer outline-[#85B72C] outline-4 outline  md:w-8 w-8 md:h-8 h-10 object-cover"
                        src={user.photoURL}
                        alt=""
                      />
                    ...
                    <Link to="/login" className="btn bg-[#85B72C] text-white">
                      Log in
                    </Link>
                  )}
                </ul>
          ...
          <div className="block bg-[rgb(228,240,250)]">
            <Outlet></Outlet>
          </div>
        </div>
