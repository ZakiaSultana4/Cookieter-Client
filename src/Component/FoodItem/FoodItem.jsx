            ...
            <ScrollAnimation>
                <div className="py-3  px-8">
                    <div className="flex gap-2 items-center">
                        ...
                        <p className="md:text-sm text-xs font-bold">Donated by {food.donarName}</p>
                    </div>
                    ...
                    <div>
                        <button onClick={() => navigate(`/food/${food._id}`)} className=" bg-[#85B72C]
                         mt-1 md:px-5 px-3 py-3  rounded-lg shadow-md font-bold md:text-sm text-xs w-full
